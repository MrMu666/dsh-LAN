		...
		(function mobileAdapt() {
			...
			function onClickCapture(e) {
				...
				if (t.closest('[class$="_sidebarCol"]')) {
					...
					// row-actions ellipsis (or its opened menu anchor) must NOT
					// collapse the sidebar — they open the session action menu.
					// v76: clicking New Session also folds the sidebar after
					// creating a conversation.
					const newSessionClicked = t.closest('[class$="_newSession"], [class$="_brand"]') !== null;
					if ((t.closest('[class$="_sessionRow"], [class$="_settingsArea"]') || newSessionClicked) && t.closest('[class$="_rowActions"]') === null) collapseSidebar();
					return;
				}
